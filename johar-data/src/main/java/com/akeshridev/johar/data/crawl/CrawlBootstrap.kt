...
internal object CrawlBootstrap {
    fun rootKeywords(rootEntityId: String): List<CrawlKeyword> = buildList {
        ...
        seed(rootEntityId, DiscoveryCategory.PLACES, "hills in Jharkhand")
        seed(rootEntityId, DiscoveryCategory.PLACES, "lakes in Jharkhand")
        seed(rootEntityId, DiscoveryCategory.PLACES, "dams in Jharkhand")
        seed(rootEntityId, DiscoveryCategory.PLACES, "temples in Jharkhand")
        seed(rootEntityId, DiscoveryCategory.PLACES, "wildlife sanctuaries in Jharkhand")
        seed(rootEntityId, DiscoveryCategory.PLACES, "heritage places in Jharkhand")
        ...
        seed(rootEntityId, DiscoveryCategory.FOOD, "tribal food of Jharkhand")
        seed(rootEntityId, DiscoveryCategory.FOOD, "forest food of Jharkhand")
        seed(rootEntityId, DiscoveryCategory.FOOD, "local ingredients of Jharkhand")
        ...
        seed(rootEntityId, DiscoveryCategory.FESTIVALS, "local fairs of Jharkhand")
        ...
        seed(rootEntityId, DiscoveryCategory.CULTURE, "music of Jharkhand")
        seed(rootEntityId, DiscoveryCategory.CULTURE, "crafts of Jharkhand")
        seed(rootEntityId, DiscoveryCategory.CULTURE, "languages of Jharkhand")
        seed(rootEntityId, DiscoveryCategory.CULTURE, "traditional art of Jharkhand")

        seed(rootEntityId, DiscoveryCategory.EMERGENCY, "hospitals in Jharkhand")
        seed(rootEntityId, DiscoveryCategory.EMERGENCY, "clinics in Jharkhand")
        seed(rootEntityId, DiscoveryCategory.EMERGENCY, "police stations in Jharkhand")
        seed(rootEntityId, DiscoveryCategory.EMERGENCY, "fire stations in Jharkhand")
        seed(rootEntityId, DiscoveryCategory.EMERGENCY, "ambulance services in Jharkhand")
        ...
        seed(rootEntityId, DiscoveryCategory.LOCAL_BAZAR, "mandi in Jharkhand")
        seed(rootEntityId, DiscoveryCategory.LOCAL_BAZAR, "vegetable markets in Jharkhand")
        seed(rootEntityId, DiscoveryCategory.LOCAL_BAZAR, "fish markets in Jharkhand")
